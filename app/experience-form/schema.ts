...
export type TExperience = z.infer<ReturnType<typeof getFormSchema>>;
...
export const getFormSchema = () => {
    ...
    return z.object({
        ...
        // industry: z.enum([data], { required_error: 'You must select an industry' }),
        industry: z.enum(data.map((industry: any) => industry.name), { required_error: 'You must select an industry' }),
